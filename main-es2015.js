...
class Project {
    constructor(id, name, date, desc, link, images) {
        this.id = id;
        this.name = name;
        this.date = date;
        this.desc = desc;
...
class Tab {
    constructor(name, section, link, state) {
        this.state = false;
        this.name = name;
...
let CliComponent = CliComponent_1 = class CliComponent {
    constructor(router) {
...
let ProjectComponent = class ProjectComponent {
    constructor() {
        this.projects = _classes__WEBPACK_IMPORTED_MODULE_2__["Folder"].projects.sort((a, b) => {
...
let DimensionsDirective = class DimensionsDirective {
    constructor(el) {
        this.el = el;
    }
    ngOnInit() {
...
let FilterPipe = FilterPipe_1 = class FilterPipe {
    transform(items, searchText) {
        ...
        FilterPipe_1.found = items.filter(it => {
